...
import 'package:developer_assistant/aws/s3/s3allbuckets.dart';
import 'package:developer_assistant/aws/s3/s3home.dart';
...
void main() {
  runApp(MaterialApp(
    ...
    routes: {
      ...
      's3home': (context) => S3home(),
      's3allbuckets': (context) => S3allbuckets(),
    },
  ));
}
